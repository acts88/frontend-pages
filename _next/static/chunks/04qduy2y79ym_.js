...
`,v=o.default.input.withConfig({componentId:"zh__sc-6a90354c-9"})`
  width: 100%;
  min-width: 0;
  border: none;
...
`,C=o.default.span.withConfig({componentId:"zh__sc-6a90354c-10"})`
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
`,E=o.default.div.withConfig({componentId:"zh__sc-6a90354c-18"})`
  ...
  line-height: 20px;
  color: #6b7280;
`,P={PROVIDE:"ⓘ 초기서류 1·2·3·5번이 모두 전산완료되면 자동 생성됩니다.",TERMINATE:"ⓘ 계약 종료 30일 전 또는 중도 해지 시, 8·9번이 자동 생성됩니다.",OTHERS:"ⓘ 예외지급 공문은 이용자별 보기에서 확인할 수 있습니다."},G={"연동 완료":"linked","업데이트 필요":"needUpdate","출력 대기":"waiting"},L=e=>G[e]??"waiting",F=o.default.div.withConfig({componentId:"zh__sc-ca3efb39-0"})`
  display: flex;
  flex: 1 0 0;
  flex-direction: column;
  gap: 16px;
...
`,M=o.default.div.withConfig({componentId:"zh__sc-ca3efb39-1"})`
  ...
  line-height: normal;
  color: #0f0f14;
`,A=o.default.div.withConfig({componentId:"zh__sc-ca3efb39-2"})`
  overflow-x: auto;
  align-self: stretch;
...
`,D=o.default.header.withConfig({componentId:"zh__sc-ca3efb39-5"})`
  ...
  gap: 4px;
  min-height: 58px;
`,H=o.default.h3.withConfig({componentId:"zh__sc-ca3efb39-6"})`
  margin: 0;
  ...
  line-height: 20px;
  color: #171a21;
`,K=o.default.p.withConfig({componentId:"zh__sc-ca3efb39-7"})`
  margin: 0;
  ...
  line-height: 17px;
  color: #5e6673;
`,V=o.default.div.withConfig({componentId:"zh__sc-ca3efb39-8"})`
  flex: 1;
