...
`,x=(0,l.default)(s.default.Button.Outlined).withConfig({componentId:"zh__sc-afc36c84-5"})`
  ...
  height: 36px;
  padding: 8px 16px;
`;var g=e.i(26546),b=e.i(71723);let m=(e,t)=>12*e+(t-1),_=function(e){let{targetYearMonth:n,onShiftMonth:i}=e,d=(e=>{if("string"!=typeof e)return null;let t=e.match(/^(\d{4})-(\d{2})$/);if(null===t)return null;let n=Number(t[1]),i=Number(t[2]);return Number.isNaN(n)||Number.isNaN(i)||i<1||i>12?null:{year:n,month:i}})(n),l=new Date,o=d?.year??l.getFullYear(),r=d?.month??l.getMonth()+1,s=o-50,a=Array.from({length:o+50-s+1},(e,t)=>s+t);return(0,t.jsxs)(w,{children:[(0,t.jsx)(v,{type:"button",onClick:()=>i(-1),children:(0,t.jsx)(g.ChevronLeft,{size:18,strokeWidth:2.5})}),(0,t.jsxs)(I,{children:[(0,t.jsx)(j,{value:String(o),onChange:e=>{let t;0!=(t=m(Number(e.currentTarget.value),r)-m(o,r))&&i(t)},children:a.map(e=>(0,t.jsxs)("option",{value:e,children:[e,"년"]},e))}),(0,t.jsx)(j,{value:String(r),onChange:e=>{let t;0!=(t=m(o,Number(e.currentTarget.value))-m(o,r))&&i(t)},children:Array.from({length:12},(e,t)=>t+1).map(e=>(0,t.jsxs)("option",{value:e,children:[e,"월"]},e))})]}),(0,t.jsx)(v,{type:"button",onClick:()=>i(1),children:(0,t.jsx)(b.ChevronRight,{size:18,strokeWidth:2.5})})]})},w=l.default.div.withConfig({componentId:"zh__sc-f9837b7b-0"})`
  display: flex;
  gap: 12px;
  align-items: center;
  justify-content: center;
...
`,I=l.default.div.withConfig({componentId:"zh__sc-f9837b7b-1"})`
  display: flex;
  gap: 8px;
  align-items: center;
`,j=(0,l.default)(s.default.Input.Select).withConfig({componentId:"zh__sc-f9837b7b-2"})`
  width: 116px;
  height: 36px;
  font-weight: 700;
`,v=l.default.button.withConfig({componentId:"zh__sc-f9837b7b-3"})`
  cursor: pointer;
  ...
  background: #fff;
`;var C=e.i(67096),D=e.i(33832),y=e.i(553),z=e.i(21771),$=e.i(44534);function O(e){return void 0===e?"-":`${e.toLocaleString("ko-KR")}원`}function E(e){let t=new Date(e);if(Number.isNaN(t.getTime()))return e;let n=t.getMonth()+1,i=t.getDate(),d=["일","월","화","수","목","금","토"][t.getDay()];return`${n}/${i} ${d}`}let N=function(e){let{schedule:n,isSubmitting:i,onClose:l,onConfirm:o}=e,r=(0,d.useMemo)(()=>n.map(e=>({value:String(e.sequence),label:`${e.sequence}회차 (${E(e.serviceDate)})`})),[n]),[s,a]=(0,d.useState)(r[0]?.value??null),c=null!==s&&r.some(e=>e.value===s)?s:r[0]?.value??null,f=!0===i||0===r.length||null===c;return(0,t.jsx)(P,{children:(0,t.jsxs)(R,{onClick:e=>e.stopPropagation(),children:[(0,t.jsxs)(T,{children:[(0,t.jsx)(S,{children:"선택한 회차를 일괄 [제공 완료] 처리할까요?"}),(0,t.jsxs)(k,{children:[(0,t.jsx)(V,{children:"회차 선택"}),(0,t.jsx)(A,{value:c??"",onChange:e=>a(e.currentTarget.value),disabled:0===r.length,children:r.map(e=>(0,t.jsx)("option",{value:e.value,children:e.label},e.value))})]}),(0,t.jsxs)(L,{children:["선택한 회차에서 [미입력] 상태인 계약 중 이용자만 [완료]로 변경됩니다.",(0,t.jsx)("br",{}),"[미제공] 또는 [종료] 상태의 이용자는 변경되지 않습니다."]})]}),(0,t.jsxs)(M,{children:[(0,t.jsx)(q,{type:"button",onClick:l,disabled:i,children:"취소"}),(0,t.jsx)(F,{type:"button",disabled:f,onClick:()=>{null!==c&&o(Number(c))},children:"완료 처리하기"})]})]})})},P=l.default.div.withConfig({componentId:"zh__sc-a08696c9-0"})`
  position: fixed;
  z-index: 3000;
  inset: 0;
...
`,T=l.default.div.withConfig({componentId:"zh__sc-a08696c9-2"})`
  display: flex;
  flex-direction: column;
  gap: 16px;
  align-items: flex-start;
`,S=l.default.h3.withConfig({componentId:"zh__sc-a08696c9-3"})`
  font-size: 16px;
  font-weight: 700;
  font-style: normal;
...
`,eu=(0,l.default)(s.default.Button.Filled.Primary).withConfig({componentId:"zh__sc-d2db635d-15"})`
  ...
  height: 36px;
  padding: 8px 16px;
`,ep={managementNumber:"desc",name:"asc"},ex={PROVIDED:"완료",NOT_PROVIDED:"NOT_PROVIDED",OUT_OF_PERIOD:"OUT_OF_PERIOD",OUT_OF_PERIOD_RECORDED:"에러 : 기간 외 입력됨"},eg={HOSPITALIZATION:"병원 입원",AWAY_OR_OUTING:"부재중/외출",CLIENT_REFUSAL:"본인 거부"};function eb(e){return!1===e.isPending}function em(e){return void 0!==e&&(!0===e.isPending||"PROVIDED"===e.status||"NOT_PROVIDED"===e.status)}function e_(e,t,n){if("OUT_OF_PERIOD"!==e)return ex[e];let{firstPatchableIndex:i,lastPatchableIndex:d}=n;return null!==i&&t<i?"/":null!==d&&t>d?"종료":ex[e]}function ew(e,t,n){return"미입력"===n?"#45464E":"/"===n?"#b1b8be":"종료"===n?"PRESSED"===t?"#47574f":"#5a6b62":"PROVIDED"===e?"#027a48":"NOT_PROVIDED"===e?"#b42318":"#667085"}function eI(e,t,n){return"미입력"===n?"HOVER"===t?"#F9FAFB":"PRESSED"===t?"#F2F4F7":"#ffffff":"/"===n?"HOVER"===t?"#f9fafb":"PRESSED"===t?"#f2f4f7":"#ffffff":"종료"===n?"HOVER"===t?"#e5ebe7":"PRESSED"===t?"#d8e1db":"#eff3f0":"PROVIDED"===e?"HOVER"===t?"#e2f3e9":"PRESSED"===t?"#d8e9df":"#ecfdf3":"NOT_PROVIDED"===e?"HOVER"===t?"#f4e9e8":"PRESSED"===t?"#eadfde":"#fef3f2":"#fff"}function ej({label:e,width:n,sortValue:i,currentSortKey:d,currentSortOrder:l,onSort:o}){let r=d===i,s=r?l:ep[i],a=r?"#131416":"#9ca3af";return(0,t.jsx)(eS,{$width:n,children:(0,t.jsx)(eL,{type:"button",onClick:()=>o(i),children:(0,t.jsxs)(eM,{children:[(0,t.jsx)(eq,{children:e}),(0,t.jsx)(eF,{children:"desc"===s?(0,t.jsx)(C.default,{sx:{fontSize:14,color:a}}):(0,t.jsx)(D.default,{sx:{fontSize:14,color:a}})})]})})})}let ev=function(e){let{rows:n,schedule:i,sortKey:l,sortOrder:o,onSort:r,onPatchCell:s,onPatchRecords:a}=e,[c,f]=(0,d.useState)("ALL"),[h,u]=(0,d.useState)(""),[p,x]=(0,d.useState)(null),[g,b]=(0,d.useState)(!1),[m,_]=(0,d.useState)(!1),[w,I]=(0,d.useState)(!1),j=(0,d.useMemo)(()=>n.map(e=>{let t,n,d=(t=null,n=null,i.forEach((i,d)=>{void 0!==e.cells.find(e=>e.sequence===i.sequence&&e.serviceDate===i.serviceDate&&void 0!==e&&!0!==e.isPending&&("PROVIDED"===e.status||"NOT_PROVIDED"===e.status))&&(null===t&&(t=d),n=d)}),{firstPatchableIndex:t,lastPatchableIndex:n});return{...e,_searchable:$.default.create(e.clientName),_patchableRange:d,_isTerminated:i.some((t,n)=>{let i=e.cells.find(e=>e.sequence===t.sequence&&e.serviceDate===t.serviceDate);return void 0!==i&&!0===eb(i)&&"종료"===e_(i.status,n,d)})}}),[n,i]),v=(0,d.useMemo)(()=>j.filter(e=>!0===e._isTerminated).length,[j]),C=(0,d.useMemo)(()=>j.length-v,[j,v]),D=(0,d.useMemo)(()=>j.filter(e=>!0===$.default.isMatch(e._searchable,h)&&("ACTIVE"===c?!0!==e._isTerminated:"TERMINATED"!==c||!0===e._isTerminated)),[j,c,h]),P=(0,d.useMemo)(()=>i.filter(e=>j.filter(e=>!0!==e._isTerminated).some(t=>t.cells.some(t=>t.sequence===e.sequence&&t.serviceDate===e.serviceDate&&!0===t.isPending))),[j,i]),R=i.length>0?i.length:8,T=async e=>{if(null===e)return;let t=i.find(t=>t.sequence===e),n=P.find(t=>t.sequence===e);if(void 0===t||void 0===n)return;let d=j.filter(e=>!0!==e._isTerminated).flatMap(e=>{let n=e.cells.find(e=>e.sequence===t.sequence&&e.serviceDate===t.serviceDate);return void 0===n||!0!==n.isPending?[]:[{contractId:e.contractId,serviceDate:n.serviceDate,pending:!1,provided:!0,reason:null}]});if(0===d.length)return void _(!1);I(!0);let l=await a(d);I(!1),!0===l&&_(!1)},S=async e=>{if(null===p)return;let t=null;if(!1===e.pending&&!0===e.provided&&(t={contractId:p.contractId,serviceDate:p.serviceDate,pending:!1,provided:!0,reason:null}),!1===e.pending&&!1===e.provided&&null!==e.reason&&(t={contractId:p.contractId,serviceDate:p.serviceDate,pending:!1,provided:!1,reason:e.reason}),!0===e.pending&&(t={contractId:p.contractId,serviceDate:p.serviceDate,pending:!0}),null===t)return;b(!0);let n=await s(t);b(!1),!0===n&&x(null)};return(0,t.jsxs)(eC,{children:[(0,t.jsxs)(eD,{children:[(0,t.jsxs)(ey,{children:[(0,t.jsxs)(ez,{type:"button",$active:"ALL"===c,onClick:()=>f("ALL"),children:["전체 이용자 (",n.length,"명)"]}),(0,t.jsxs)(ez,{type:"button",$active:"ACTIVE"===c,onClick:()=>f("ACTIVE"),children:["계약중 (",C,"명)"]}),(0,t.jsxs)(ez,{type:"button",$active:"TERMINATED"===c,onClick:()=>f("TERMINATED"),children:["종료 (",v,"명)"]})]}),(0,t.jsxs)(e$,{children:[(0,t.jsxs)(eO,{children:[(0,t.jsx)(eE,{value:h,onChange:e=>u(e.currentTarget.value),placeholder:"이용자명 검색"}),(0,t.jsx)(eN,{children:(0,t.jsx)(y.Search,{color:"#0a0a0a",size:16})})]}),(0,t.jsx)(eP,{type:"button",onClick:()=>{_(!0)},disabled:0===P.length||w,children:"선택 회차 전체 완료 처리"})]})]}),(0,t.jsx)(eR,{children:(0,t.jsxs)(eT,{children:[(0,t.jsxs)("thead",{children:[(0,t.jsxs)("tr",{children:[(0,t.jsx)(ek,{$width:84,"aria-hidden":"true"}),(0,t.jsx)(ek,{$width:120,"aria-hidden":"true"}),(0,t.jsx)(ek,{$width:110,"aria-hidden":"true"}),(0,t.jsx)(eV,{colSpan:R,children:"회차별 제공일 및 제공 상태"}),(0,t.jsx)(ek,{$width:140,"aria-hidden":"true"}),(0,t.jsx)(ek,{$width:90,"aria-hidden":"true"}),(0,t.jsx)(ek,{$width:165,"aria-hidden":"true"}),(0,t.jsx)(ek,{$width:164,"aria-hidden":"true"}),(0,t.jsx)(ek,{$width:164,"aria-hidden":"true"})]}),(0,t.jsxs)("tr",{children:[(0,t.jsx)(ej,{label:"관리번호",width:84,sortValue:"managementNumber",currentSortKey:l,currentSortOrder:o,onSort:r}),(0,t.jsx)(ej,{label:"성명",width:120,sortValue:"name",currentSortKey:l,currentSortOrder:o,onSort:r}),(0,t.jsx)(eS,{$width:110,children:"생년월일"}),i.length>0?i.map((e,n)=>(0,t.jsxs)(eU,{$isFirstInSchedule:0===n,$isLastInSchedule:n===i.length-1,children:[(0,t.jsxs)(eB,{children:[e.sequence,"회차"]}),(0,t.jsx)(eG,{children:E(e.serviceDate)})]},`${e.sequence}-${e.serviceDate}`)):Array.from({length:R},(e,n)=>(0,t.jsxs)(eU,{$isFirstInSchedule:0===n,$isLastInSchedule:n===R-1,children:[(0,t.jsxs)(eB,{children:[n+1,"회차"]}),(0,t.jsx)(eG,{children:"일정 없음"})]},`empty-schedule-header-${n}`)),(0,t.jsx)(eS,{$width:140,children:"제공 횟수"}),(0,t.jsx)(eS,{$width:90,children:(0,t.jsxs)(eA,{children:["바우처",(0,t.jsx)("br",{}),"등급"]})}),(0,t.jsx)(eS,{$width:165,children:"예상 총액"}),(0,t.jsx)(eS,{$width:164,children:"정부지원금"}),(0,t.jsx)(eS,{$width:164,children:"본인부담금"})]})]}),(0,t.jsxs)("tbody",{children:[D.map(e=>{var n;let d=e._patchableRange;return(0,t.jsxs)(eH,{children:[(0,t.jsx)(eY,{$width:84,children:e.managementNumber??"-"}),(0,t.jsx)(eY,{$width:120,children:(0,t.jsxs)(eK,{children:[(0,t.jsx)("span",{children:e.clientName}),(0,t.jsx)(eW,{$terminated:e._isTerminated,children:e._isTerminated?"종료":"계약중"})]})}),(0,t.jsx)(eY,{$width:110,children:null===(n=e.birthDate)||!0!==z.default.is(n)?"-":n.replaceAll("-",".")}),i.length>0?i.map((n,l)=>{let o=e.cells.find(e=>e.sequence===n.sequence&&e.serviceDate===n.serviceDate),r=o&&eb(o)?e_(o.status,l,d):void 0,s=o&&!1===o.isPending&&"NOT_PROVIDED"===o.status&&null!==o.reason?eg[o.reason]??null:null,a=o?.isPending===!0?"미입력":s??r,c="/"===a;return(0,t.jsx)(eZ,{$status:o&&eb(o)?o.status:void 0,$displayLabel:a,$clickable:em(o),$isLastInSchedule:l===i.length-1,onClick:()=>{if(void 0!==o&&!0===em(o)){if(!0===o.isPending)return void x({contractId:e.contractId,clientName:e.clientName,sequence:o.sequence,serviceDate:o.serviceDate,isPending:!0,status:null,reason:null});x({contractId:e.contractId,clientName:e.clientName,sequence:o.sequence,serviceDate:o.serviceDate,isPending:!1,status:o.status,reason:"NOT_PROVIDED"===o.status?o.reason:null})}},children:o?(0,t.jsx)(eX,{children:(0,t.jsx)(eJ,{$isSlashLabel:c,children:a})}):"-"},`${e.contractId}-${n.sequence}`)}):Array.from({length:R},(n,i)=>(0,t.jsx)(eZ,{$clickable:!1,$isLastInSchedule:i===R-1,children:"-"},`${e.contractId}-empty-schedule-${i}`)),(0,t.jsxs)(e0,{children:[e.providedCount,"회 제공 / 전체 ",e.cells.length,"회"]}),(0,t.jsx)(eQ,{$width:90,children:e.grade}),(0,t.jsx)(eQ,{$width:165,children:O(e.expectedTotalAmount)}),(0,t.jsx)(e1,{$width:164,children:O(e.expectedGovernmentSupportAmount)}),(0,t.jsx)(e2,{$width:164,children:O(e.expectedCopaymentAmount)})]},e.contractId)}),0===D.length&&(0,t.jsx)(eH,{children:(0,t.jsx)(e6,{colSpan:8+R,children:"표시할 이용자 데이터가 없습니다."})})]})]})}),null!==p&&(0,t.jsx)(X,{selectedStatusCell:p,onClose:()=>{g||x(null)},onSubmit:S,isSubmitting:g},`${p.contractId}-${p.sequence}-${p.serviceDate}`),m&&(0,t.jsx)(N,{schedule:P,isSubmitting:w,onClose:()=>{w||_(!1)},onConfirm:e=>void T(e)})]})},eC=l.default.section.withConfig({componentId:"zh__sc-2bddfd82-0"})`
  overflow: hidden;
  border: 1px solid #e5e7eb;
  border-radius: 10px;
`,eD=l.default.div.withConfig({componentId:"zh__sc-2bddfd82-1"})`
  display: flex;
  gap: 12px;
  align-items: center;
  justify-content: space-between;
  ...
  background: #fff;
`,ey=l.default.div.withConfig({componentId:"zh__sc-2bddfd82-2"})`
  overflow: hidden;
  display: flex;
  align-items: stretch;
...
`,eE=(0,l.default)(s.default.Input.Text).withConfig({componentId:"zh__sc-2bddfd82-6"})`
  ...
  font-size: 16px;
  color: #101828;
`,eN=l.default.span.withConfig({componentId:"zh__sc-2bddfd82-7"})`
  pointer-events: none;
  ...
  width: 16px;
  height: 16px;
`,eP=(0,l.default)(s.default.Button.Filled.Primary).withConfig({componentId:"zh__sc-2bddfd82-8"})`
  display: flex;
  gap: 4px;
  align-items: center;
  align-self: stretch;
...
`,eR=l.default.div.withConfig({componentId:"zh__sc-2bddfd82-9"})`
  overflow: auto;
`,eT=l.default.table.withConfig({componentId:"zh__sc-2bddfd82-10"})`
  table-layout: fixed;
...
`,eS=l.default.th.withConfig({componentId:"zh__sc-2bddfd82-11"})`
  ...
  background: #f8fafc;
`,ek=(0,l.default)(eS).withConfig({componentId:"zh__sc-2bddfd82-12"})`
  color: transparent;
`,eV=(0,l.default)(eS).withConfig({componentId:"zh__sc-2bddfd82-13"})`
...
`,eF=l.default.span.withConfig({componentId:"zh__sc-2bddfd82-18"})`
  ...
  display: inline-flex;
  align-items: center;
`,eU=(0,l.default)(eS).withConfig({componentId:"zh__sc-2bddfd82-19"})`
  width: 64px;
  min-width: 64px;
  height: 48px;
  padding: 0;
...
`,eZ=(0,l.default)(eY).withConfig({componentId:"zh__sc-2bddfd82-26"})`
  ...
  background: ${({$status:e,$displayLabel:t})=>eI(e,"DEFAULT",t)};

  &:hover {
    color: ${({$status:e,$displayLabel:t})=>ew(e,"HOVER",t)};
    background: ${({$status:e,$displayLabel:t})=>eI(e,"HOVER",t)};
  }

  &:active {
    color: ${({$status:e,$displayLabel:t})=>ew(e,"PRESSED",t)};
    background: ${({$status:e,$displayLabel:t})=>eI(e,"PRESSED",t)};
  }
...
`,e6=l.default.td.withConfig({componentId:"zh__sc-2bddfd82-33"})`
  ...
  text-align: center;
  vertical-align: middle;
`,e8=function(e){let{summary:n}=e;return(0,t.jsxs)(e3,{children:[(0,t.jsxs)(e4,{children:[(0,t.jsx)(e5,{children:"당월 최종 예상 결제금액 합계"}),(0,t.jsx)(e9,{children:O(n?.totalExpectedAmount)})]}),(0,t.jsxs)(e4,{$tone:"blue",children:[(0,t.jsx)(e5,{children:"예상 정부지원금 합계"}),(0,t.jsx)(e9,{$tone:"blue",children:O(n?.totalExpectedGovernmentSupportAmount)})]}),(0,t.jsxs)(e4,{$tone:"red",children:[(0,t.jsx)(e5,{children:"예상 본인부담금 합계"}),(0,t.jsx)(e9,{$tone:"red",children:O(n?.totalExpectedCopaymentAmount)})]})]})},e3=l.default.section.withConfig({componentId:"zh__sc-c5ef9cf1-0"})`
  display: grid;
  grid-template-columns: repeat(3, minmax(0, 1fr));
  gap: 12px;
...
`,e5=l.default.p.withConfig({componentId:"zh__sc-c5ef9cf1-2"})`
  margin: 0;
